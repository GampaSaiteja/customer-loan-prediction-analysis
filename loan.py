...
trainingDataset = pd.read_csv(r"D:\MINI PROJECTS-24\CMRIT\AI-ML\A-SEC\Loan Prediction using Machine Learning Algorithm\Loan Prediction using Machine Learning Algorithm\Code\train_LoanPrediction.csv")
testingDataset = pd.read_csv(r"D:\MINI PROJECTS-24\CMRIT\AI-ML\A-SEC\Loan Prediction using Machine Learning Algorithm\Loan Prediction using Machine Learning Algorithm\Code\test_LoanPrediction.csv")
